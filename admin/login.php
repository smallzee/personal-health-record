<?php
	...
	if(isset($_POST['ok'])){
		...
		$sql = $db->prepare("SELECT id FROM admin WHERE username = :username and password= :password");
		$sql->execute(
			array(
	...
	<body>
		...
		<div class="container" style='margin-top: 45px;'>
			<div class="row">
				...
				<div class="main-bg">
					<div class="inner-bg">
						<h3 class="page-header"><i class="fa fa-lock"></i> <?php echo $config['site_short_name'];?> Admin Login</h3>
